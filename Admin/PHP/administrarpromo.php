...
<html lang="es">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
       ...
       <div>
           <h1 style="text-align: center;">Administrar Promociones</h1>
                ...
                <table class="table table-hover" ">
                    ...
                    <?php
                      include('../conectar_utd.php');
                        ...
                        $sel=$conexion->query("SELECT * from promociones");
                        ...
                        <tr >
                            ...
                            <td class="table_data"><?php echo $fila['Descripcion']  ?></td>
                            <td class="table_data"><?php echo $fila['Fecha_expiracion']  ?></td>
                            <td class="table_data"><?php echo $fila['Usuario']  ?></td>
